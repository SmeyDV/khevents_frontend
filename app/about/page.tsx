  ...
  const teamMembers = [
    {
      ...
      bio: "With over 15 years of experience in event management across Cambodia, Sopheap founded KhmerEvents to showcase the country's rich cultural heritage.",
    },
    {
      name: "Channary Kim",
      role: "Chief Marketing Officer",
      image: "/placeholder.svg?height=200&width=200",
      bio: "Channary brings her expertise in digital marketing and tourism to help connect Cambodians and visitors with authentic local experiences.",
    },
    {
      name: "Visal Prak",
      role: "Head of Partnerships",
      image: "/placeholder.svg?height=200&width=200",
      bio: "Visal works closely with event organizers, venues, and cultural institutions to bring the best events to our platform.",
    },
  ]
